...
import dash_table
from pp.utils2 import Header
from pp import ret
import pandas as pd
import pathlib

# get relative data folder
cota = pd.read_csv('https://raw.githubusercontent.com/luizaidgr/daqui/master/34691362000198/df_graph.csv',sep=',', index_col=0)
...
df_price_perf = pd.read_csv('https://raw.githubusercontent.com/luizaidgr/daqui/master/34691362000198/tabela1.csv',sep=',')
...
df_series_pl = pd.read_csv('https://raw.githubusercontent.com/luizaidgr/daqui/master/34691362000198/Serie_PL.csv',sep=',')
df_series_yp = pd.read_csv('https://raw.githubusercontent.com/luizaidgr/daqui/master/34691362000198/Serie_Y_P.csv',sep=',')
df_series_C_S = pd.read_csv('https://raw.githubusercontent.com/luizaidgr/daqui/master/34691362000198/Serie_C_S.csv',sep=',')
                        ...
                        [
                            html.Div(
                                [
                                    ...
                                    html.Br([]),
                                    html.Div(id="mark",
                                             children="O FIDC ZEUS adquire direitos creditórios originários de operações realizadas no segmento comercial, preponderantemente, da cadeia de combustíveis ",
                                        style={"color": "#ffffff"},
                                        className="row",
                                    ),
                                ],
