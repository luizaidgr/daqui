...
import dash_table
from pp.utils import Header
from pp import ret
import pandas as pd
import pathlib

# get relative data folder
cota = pd.read_csv('https://raw.githubusercontent.com/luizaidgr/daqui/master/26631527000108/df_graph.csv',sep=',', index_col=0)
cdi = pd.read_csv('https://raw.githubusercontent.com/luizaidgr/daqui/master/CDI.csv',sep=',', index_col=0)
...
df_fund_facts = pd.read_csv('https://raw.githubusercontent.com/luizaidgr/daqui/master/26631527000108/df_fund_facts.csv',sep=',')
df_price_perf = pd.read_csv('https://raw.githubusercontent.com/luizaidgr/daqui/master/26631527000108/tabela1.csv',sep=',')
...
df_series_pl = pd.read_csv('https://raw.githubusercontent.com/luizaidgr/daqui/master/26631527000108/Serie_PL.csv',sep=',')
df_series_yp = pd.read_csv('https://raw.githubusercontent.com/luizaidgr/daqui/master/26631527000108/Serie_Y_P.csv',sep=',')
df_series_C_S = pd.read_csv('https://raw.githubusercontent.com/luizaidgr/daqui/master/26631527000108/Serie_C_S.csv',sep=',')
...
df_series = pd.read_csv("https://raw.githubusercontent.com/luizaidgr/daqui/master/26631527000108/Series.csv",sep=',')
                        ...
                        [
                            html.Div(
                                [
                                    ...
                                    html.Div(id="mark",
                                             children="\
                                            O Fundo FENIX FIDC NP é um FIDC não padronizado, \
                            ...
                            html.Div(
                                [
                                    ...
                                    dash_table.DataTable(
                                        id='table',
                                        columns=[{"name": i, "id": i} for i in dftudo.columns],
                                        data=dftudo.to_dict('records'),
